        ...
        >
          ...
          <div className="flex-grow flex items-end justify-center gap-4 md:gap-8 mt-12 h-52 pb-4">
            ...
            <div className="flex flex-col items-center gap-3">
              <span className="podium-reward font-fredoka font-semibold text-[#202b8c] text-lg z-10">$80</span>
              <div
            ...
            {/* 1st Place */}
            <div className="flex flex-col items-center gap-3">
              <span className="podium-reward font-fredoka font-semibold text-[#101545] text-xl z-10">$100</span>
              <div
            ...
            {/* 3rd Place */}
            <div className="flex flex-col items-center gap-3">
              <span className="podium-reward font-fredoka font-semibold text-[#3442c7] text-lg z-10">$60</span>
              <div
